...
export const metadata: Metadata = {
  title: 'Contact Flo Faction LLC | Professional Business Services',
  description: 'Contact Flo Faction LLC for professional business services. Insurance, music production, emergency management, videography, and digital marketing solutions.',
  keywords: 'contact, Flo Faction LLC, business services, insurance, music, emergency management, videography, marketing',
  openGraph: {
    title: 'Contact Flo Faction LLC | Professional Business Services',
    description: 'Contact Flo Faction LLC for professional business services. Insurance, music production, emergency management, videography, and digital marketing solutions.',
    type: 'website',
    url: 'https://www.flofaction.com/contact',
...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Ready to work with Flo Faction? Get in touch with our team to discuss your project needs and how we can help your business succeed.
            </p>
          </div>
        </div>
      </section>
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="music">Music & Sync Licensing</option>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-2">flofaction.insurance@gmail.com</p>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-2">+1 (772) 208-9646</p>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-2">Florida, USA</p>
      ...
      {/* AI Assistant Widget Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">Chat with Our AI Assistant</h2>
            <p className="text-xl text-blue-50 max-w-2xl mx-auto">Get instant answers to your questions 24/7 with our AI-powered assistant powered by ElevenLabs</p>
          </div>
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            <script src="https://convai.elevenlabs.io/conva.js" async></script>
            <elevenlabs-convai agent-id="agent_6801kca6phc8e9kr6kpk497eapsr"></elevenlabs-convai>
          </div>
        </div>
      </section>
          </div>
